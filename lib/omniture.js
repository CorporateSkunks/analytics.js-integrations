...
/**
 * Get mappings and apply overrides for a given event
 */
Omniture.prototype.getEventMapping = function(key, overrideProps) {
...
Omniture.prototype.track = function(track, properties) {
    ...
    var mapping = this.getEventMapping(eventName, props);
